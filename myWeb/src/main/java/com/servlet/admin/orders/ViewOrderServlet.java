...
/**
 * 后台用于查看订单详细内容的Servlet
 */
@WebServlet("/com.servlet.admin.orders/ViewOrderServlet")
public class ViewOrderServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/admin/orders/view.jsp").forward(request, response);
    }
